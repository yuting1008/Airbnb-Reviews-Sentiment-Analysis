# -*- coding: utf-8 -*-
"""Text Mining Final Project BERT(copy)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mvBYliUZm70g8_kFOISgHGTJiLgsHOkT

如果沒有要求再改參數的話(像是正負面的那個)，可以從頭執行看看了，我依然解不開review，不過我有簡單分群過，似乎有點東西，各位辛苦了
"""
